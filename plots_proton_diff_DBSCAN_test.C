...
Int_t plots_proton_diff_DBSCAN_test(){

  TString fileN01;
  TString fileN02;
  //
  //fileN01 = "./hist_rate_proton_diff.root";
  //fileN02 = "./hist_rate_proton_diff_test.root";
  //
  fileN01 = "./hist_rate_proton_diff_test_superwlower.root";
  fileN02 = "./hist_rate_proton_diff_test_superwlower.root";
  //
  TFile *f01 = new TFile(fileN01.Data());
  TFile *f02 = new TFile(fileN02.Data());
  //
  TH1D *h1_tot = (TH1D*)f01->Get("_h1_rate_tot_vs_th");
  TH1D *h1_tot02 = (TH1D*)f02->Get("_h1_rate_tot_vs_th");
  TH1D *h1_protons = (TH1D*)f01->Get("_h1_rate_vs_th");
  TH1D *h1_protons02 = (TH1D*)f02->Get("_h1_rate_vs_th");
  ...
  //
  h1_tot02->SetLineColor(kMagenta+2);
  h1_tot02->SetLineWidth(3);
  //
  h1_protons->SetLineColor(kBlue+2);
  h1_protons->SetLineWidth(3);
  h1_protons02->SetLineColor(kBlack);
  h1_protons02->SetLineWidth(3);
  //
