...
Int_t plots_rate_vs_dbc_number_of_points(){

  TString fileN01;
  TString fileN02;
  //
  fileN01 = "../scratch/mono-lst-sipm-pmma-3ns-v1_triggerless/proton_nsb_1x/trgB//hist_trgB_corsika_run1.root";
  fileN02 = "../scratch/mono-lst-sipm-pmma-3ns-v1_triggerless/proton_nsb_1x/trgB//hist_trgB_corsika_run1_268MHz.root";
  //
  ...
  leg->AddEntry(h1_01, "p + NSB 1MHz", "apl");
  leg->AddEntry(h1_02, "p + NSB 268MHz", "apl");
  leg->Draw();
  //  
  return 0;
}
