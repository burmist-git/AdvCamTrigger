...
Int_t plots_hmax_gamma_gamma_diff_ele_diff_proton(){
  //
  TString fileN01;
  TString fileN02;
  TString fileN03;
  ...
  //
  TH1D *h1_01 = (TH1D*)f01->Get("h1_h_first_int");
  TH1D *h1_02 = (TH1D*)f02->Get("h1_h_first_int");
  TH1D *h1_03 = (TH1D*)f03->Get("h1_h_first_int");
  TH1D *h1_04 = (TH1D*)f04->Get("h1_h_first_int");
  //
  h1_01->Rebin(10);
  h1_02->Rebin(10);
  h1_03->Rebin(10);
  ...
  leg->AddEntry(h1_01, "gamma on axis", "apl");
  leg->AddEntry(h1_02, "gamma diffused", "apl");
  leg->AddEntry(h1_03, "electrons", "apl");
  leg->AddEntry(h1_04, "protons", "apl");
  leg->Draw();
  //  
  return 0;
}
