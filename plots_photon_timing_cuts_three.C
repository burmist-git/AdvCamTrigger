...
Int_t plots_photon_timing_cuts_three(){
  //
  TString fileN01;
  TString fileN02;
  TString fileN03;
  ...
  //
  TH1D *h1_01 = (TH1D*)f01->Get("h1_xcore_km_ev_time_cut_ycore");
  TH1D *h1_02 = (TH1D*)f02->Get("h1_xcore_km_ev_time_cut_ycore");
  TH1D *h1_03 = (TH1D*)f03->Get("h1_xcore_km_ev_time_cut_ycore");
  //  
